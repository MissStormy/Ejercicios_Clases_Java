...
public class Ejercicio_4 {
    public static void main(String[] args) {
        ...
        libro2.setNum_ejemplares(ejemplares);
        ...
        System.out.println("Ejemplares: " + libro1.getNum_ejemplares());
        System.out.println("Prestados: " + libro1.getNum_ejem_pres());
        System.out.println();
        ...
        System.out.println("Ejemplares: " + libro2.getNum_ejemplares());
        System.out.println("Prestados: " + libro2.getNum_ejem_pres());
        System.out.println();
    }
}
